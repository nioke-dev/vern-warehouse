                                ...
                                <div class="bg-white rounded-[20px] shadow-pricing flex flex-col overflow-hidden w-full">
                                    ...
                                    <div class="p-8 bg-white flex flex-col gap-6 border-t border-black/5">
                                        ...
                                        <div class="mt-4 flex flex-col items-center gap-4">
                                            <button class="w-full bg-black text-white h-[56px] rounded-[12px] flex items-center justify-center gap-3 font-semibold text-[16px] tracking-[-3%] hover:opacity-90 transition-opacity cursor-pointer">
